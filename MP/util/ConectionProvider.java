...
private static ConectionProvider instance;
	...
	private ConectionProvider() throws FileNotFoundException, IOException{
	...
	public static ConectionProvider getInstance() throws FileNotFoundException, ClassNotFoundException, IOException{
		if(instance==null)
